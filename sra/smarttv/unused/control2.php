...
<!-- level 1 -->
    <h3>G (General Audience)</h3>

	<div style ="padding-left:50px;">

	<h3>Program Genres</h3>
...
<!-- level 2 -->
	...
	<h3>PG (Partial Guidance Suggested)</h3>
...
<!-- level 3 -->
	...
	<h3>PG-13(Parents Strongly Cautioned)</h3>
...
<!-- level 5 -->
	...
	<h3>NC-17(No One 17 and Under Admitted)</h3>
...
<form id="contactForm" method="post" action="redirect_post.php">
    ...
    <input id="dcondition" type="hidden" name="dcondition" value="8" />
